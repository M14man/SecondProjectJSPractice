...
var forms = function forms(state) {
  ...
  upload.forEach(function (item) {
    item.addEventListener('input', function () {
      ...
      var dots;
      var arr = item.files[0].name.split('.'); // 'dsfdfdskfsd.jpg' => ['dsfdfdskfsd', 'jpg']
  ...
  forms.forEach(function (item, i) {
    item.addEventListener('submit', function (e) {
      ...
      statusMessage.classList.add('status'); // statusMessage.style.textAlign = 'center';
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_9__["postData"])(api, json).then(function (res) {
        console.log(res);
...
var pictureSize = function pictureSize(block) {
...
var scrolling = function scrolling(upSelector) {
  ...
  var calcScroll = function calcScroll() {
    upElem.addEventListener('click', function (event) {
      var scrollTop = Math.round(body.scrollTop || element.scrollTop); // тут ми просто визначаэмо скыльки ми пролистали зверху
      // console.log(scrollTop);

      if (this.hash !== '') {
        event.preventDefault(); // let hashElement = document.getElementById(this.hash.substring(1));

        var hashElement = document.querySelector(this.hash),
            // це ідентичний селектор тому що зверху
        hashElementTop = 0; // console.log(hashElement);
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  function plusSlides(n) {
    // тут ми відразу можемо передати як -1 так і 1 щоб не створювати ще одну функцію
    showSlides(slideIndex += n);
  }

  try {
    var prevBtn = document.querySelector(prev),
        // тобто якщо ці селектори не передані то цей блок коду не запрацює і не зламає в подальшому наш код
  ...
  function activateAnimation() {
    if (dir === 'vertical') {
      paused = setInterval(function () {
        plusSlides(1);
        items[slideIndex - 1].classList.add('animate__fadeInDownBig');
      }, 3000);
    } else {
      paused = setInterval(function () {
        plusSlides(1);
